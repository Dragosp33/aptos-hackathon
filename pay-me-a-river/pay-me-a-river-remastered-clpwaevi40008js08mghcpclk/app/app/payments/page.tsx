...
export default function ClaimerPage() {
  ...
  */
  ...
  const calculateClaimable = (
    ...
    const now = Date.now();
    const startInMilliseconds = startInSeconds * 1000;
    const durationInMilliseconds = durationInSeconds * 1000;
    let end_time = startInMilliseconds + durationInMilliseconds;
    if (now < end_time) {
      let milliseconds_elapsed = now - startInMilliseconds;
      console.log((milliseconds_elapsed * amount) / durationInMilliseconds);
      return (milliseconds_elapsed * amount) / durationInMilliseconds;
    }
    return amount;
  };
