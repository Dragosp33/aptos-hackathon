  ...
  */
  const startStream = async () => {
    ...
    */
    ...
    console.log(typeof address, typeof amount, typeof duration);
    ...
    */
    ...
    console.log('amount number: ', intAmount);
    ...
    */
    ...
    const factor = 10 ** 8; // 10^8 for 8 decimal places

    const intAmount8Decimals: number = Math.floor(intAmount * factor);
    console.log('amount number: ', intAmount);

    console.log('value with 8 decimals: ', intAmount8Decimals);
    console.log('parsed duration: ', parseDuration(duration));
    const payload = {
      type: 'entry_function_payload',
      function: `${process.env.MODULE_ADDRESS}::${process.env.MODULE_NAME}::create_stream`,
      type_arguments: [],
      arguments: [address, intAmount8Decimals, parseDuration(duration)],
    };
    // return;
    ...
    */
    ...
    try {
      ...
      console.log('sign and submit result: ', result);
      toast({
        title: 'Stream created!',
        description: `Stream created: to ${`${address.slice(
          0,
